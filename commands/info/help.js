...
module.exports = {
    //definition
        name: "aide", //the name of the command 
        ...
        usage: "aide [Command]", //this is for the help command for EACH cmd
        description: "Montre les commands disponible", //the description of the command
...
const embed = new MessageEmbed() //defining the Embed
    ...
    .setTitle("Menu aide")
    .setFooter(`Pour plus d'info : type ${config.prefix}aide [CMD NAME]`, client.user.displayAvatarURL())
